...
export const SharedStateProvider:React.FC<{children:ReactNode}> = ({children}:{children:ReactNode})=>{
    ...
    return <SharedStateContext.Provider value={{translationY,expandPlayer,collapsePlayer}}>
        {children}
...
export const useSharedState = ()=>{
    ...
    if (context === undefined) {
        throw new Error('useSharedState much be used within a sharedState');
    }
    return context;
};
